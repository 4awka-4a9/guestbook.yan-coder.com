...
<main class="form-signin w-100 m-auto">
  <form method="POST">
    ...
    <div class="form-floating">
      <input type="text" class="form-control input" id="floatingPassword" placeholder="Email" name="email" required=""
        value="<?php echo (!empty($_POST["email"]) ? $_POST["email"] : ''); ?>" />
      <label for="floatingPassword">Email address</label>
    </div>

    <div class="form-floating">
      <input type="text" class="form-control input" id="floatingPassword" placeholder="last name" name="first_name"
